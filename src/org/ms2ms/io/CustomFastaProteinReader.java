...
//    builder.setAccessionId((right>0?header.substring(left, right):header.substring(left)).replaceAll("\\|", "_"));
  ...
  public static EnumMap<SeqInfo, String> parseUniprotHeader(String header)
  {
    ...
    if (r0>0)          parcels.put(AC,   header.substring(0, r0));
    ...
    if (items!=null)
      for (String item : items)
      {
        ...
        if (nv!=null && nv.length>1 && "GN".equals(nv[0])) parcels.put(GN, nv[1]);

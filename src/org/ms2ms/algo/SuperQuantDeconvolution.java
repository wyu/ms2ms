...
/** Adopted from the C# version on GitHub
 *
 */
public class SuperQuantDeconvolution
{
  static double Proton = 1.00727646677; // Mass of proton
/*
  ...
  protected override MassSpectrumCollection SuperQuantDeconvolution(MassSpectrumCollection inspectra)
{

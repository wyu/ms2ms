...
*/
  ...
  public  void setSpLibs() throws IOException
  {
    ...
    HBaseSpLib.set(table, "PeptideAtlas", "sptxt", HBaseProteomics.HUMAN, "AUG2012", HBasePeakList.SPEC_TRAP_CID, "HumanPlasma_2012-08_all");
    HBaseSpLib.set(table, "PeptideAtlas", "sptxt", HBaseProteomics.HUMAN, "JUL2013", HBasePeakList.SPEC_TRAP_CID, "ISB_Hs_phospho_20130715");
    HBaseSpLib.set(table, "PeptideAtlas", "sptxt", HBaseProteomics.HUMAN, "JUL2013", HBasePeakList.SPEC_TRAP_CID, "ISB_Hs_phospho_SEMI_20130715");
    HBaseSpLib.set(table, "PeptideAtlas", "sptxt", HBaseProteomics.YEAST, "JUL2013", HBasePeakList.SPEC_TRAP_CID, "ISB_Sc_Phospho_20130715");
    HBaseSpLib.set(table, "PeptideAtlas", "sptxt", HBaseProteomics.MM, "JUL2013", HBasePeakList.SPEC_TRAP_CID, "ISB_Mm_Phospho_20130715");
    HBaseSpLib.set(table, "PeptideAtlas", "sptxt", HBaseProteomics.WORM, "JUL2013", HBasePeakList.SPEC_TRAP_CID, "ISB_Ce_Phospho_20130715_UniProt201306");
    HBaseSpLib.set(table, "PeptideAtlas", "sptxt", HBaseProteomics.DM, "JUL2013", HBasePeakList.SPEC_TRAP_CID, "ISB_Dm_Phospho_20130715_UniProt201306");

    HBaseSpLib.set(table, "NIST", "msp", HBaseProteomics.HUMAN, "JUN2013", HBasePeakList.SPEC_TRAP_HCD, "human_hcd_selected_final_true_lib");
    HBaseSpLib.set(table, "NIST", "msp", HBaseProteomics.HUMAN, "JUN2010", HBasePeakList.SPEC_TRAP_CID, "hsa_consensus_final_true_lib");
    HBaseSpLib.set(table, "NIST", "msp", HBaseProteomics.HUMAN, "MAY2009", HBasePeakList.SPEC_TRAP_CID, "human_b2mg_consensus_final_true_lib");
    HBaseSpLib.set(table, "NIST", "msp", HBaseProteomics.HUMAN, "JUN2013", HBasePeakList.SPEC_TRAP_CID, "human_consensus_final_true_lib");
    HBaseSpLib.set(table, "NIST", "msp", HBaseProteomics.HUMAN, "MAY2011", HBasePeakList.SPEC_TRAP_CID, "human_crp_consensus_final_true_lib");
    HBaseSpLib.set(table, "NIST", "msp", HBaseProteomics.MOUSE, "MAY2013", HBasePeakList.SPEC_TRAP_CID, "mouse_consensus_final_true_lib");
    HBaseSpLib.set(table, "NIST", "msp", HBaseProteomics.RAT, "MAY2013", HBasePeakList.SPEC_TRAP_CID, "rat_consensus_final_true_lib");
    HBaseSpLib.set(table, "NIST", "msp", HBaseProteomics.RAT, "JUN2013", HBasePeakList.SPEC_QTOF, "rat_qtof_consensus_final_true_lib");
    HBaseSpLib.set(table, "NIST", "msp", HBaseProteomics.YEAST, "MAY2012", HBasePeakList.SPEC_TRAP_CID, "yeast_consensus_final_true_lib");
    HBaseSpLib.set(table, "NIST", "msp", HBaseProteomics.YEAST, "MAY2012", HBasePeakList.SPEC_QTOF, "yeast_qtof_consensus_final_true_lib");
    HBaseSpLib.set(table, "NIST", "msp", HBaseProteomics.POMBE, "MAY2013", HBasePeakList.SPEC_TRAP_CID, "yeast_pombe_consensus_final_true_lib");
    HBaseSpLib.set(table, "NIST", "msp", HBaseProteomics.ECOLI, "MAY2013", HBasePeakList.SPEC_TRAP_CID, "e_coli_consensus_final_true_lib");
    HBaseSpLib.set(table, "NIST", "msp", HBaseProteomics.BOVINE, "JUN2011", HBasePeakList.SPEC_TRAP_CID, "bsa_consensus_final_true_lib");
    HBaseSpLib.set(table, "NIST", "msp", HBaseProteomics.WORM, "MAY2011", HBasePeakList.SPEC_TRAP_CID, "c_elegans_consensus_final_true_lib");
    HBaseSpLib.set(table, "NIST", "msp", HBaseProteomics.CHICK, "MAY2011", HBasePeakList.SPEC_TRAP_CID, "chicken_consensus_final_true_lib");
    HBaseSpLib.set(table, "NIST", "msp", HBaseProteomics.MM, "JUN2010", HBasePeakList.SPEC_TRAP_CID, "msmegmatis_consensus_final_true_lib");
    HBaseSpLib.set(table, "NIST", "msp", HBaseProteomics.DRADI, "JUN2010", HBasePeakList.SPEC_TRAP_CID, "dradiodurans_consensus_final_true_lib");
    HBaseSpLib.set(table, "NIST", "msp", HBaseProteomics.DROSO, "JUN2013", HBasePeakList.SPEC_TRAP_CID, "drosophila_consensus_final_true_lib");
    HBaseSpLib.set(table, "NIST", "msp", HBaseProteomics.MIXED, "JUN2010", HBasePeakList.SPEC_TRAP_CID, "nist_nci_stdmix_consensus_final_true_lib");
    HBaseSpLib.set(table, "NIST", "msp", HBaseProteomics.MIXED, "MAY2011", HBasePeakList.SPEC_TRAP_CID, "sigmaups1_consensus_final_true_lib");

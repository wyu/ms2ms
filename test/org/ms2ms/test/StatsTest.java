...
public class StatsTest extends TestAbstract
{
  ...
  {
    System.out.println(Stats.aggregate(Lists.newArrayList(2.3, 5.6, 2.5),     Stats.Aggregator.COUNT));
    System.out.println(Stats.aggregate(Lists.newArrayList(2.3, "5.6", 2.5),   Stats.Aggregator.COUNT));
    System.out.println(Stats.aggregate(Lists.newArrayList(2.3, 5.6, 2.5),     Stats.Aggregator.MEAN));
    System.out.println(Stats.aggregate(Lists.newArrayList(2.3, "5.6", 2.5),   Stats.Aggregator.MEAN));
    System.out.println(Stats.aggregate(Lists.newArrayList(2.3, "5.6TT", 2.5), Stats.Aggregator.MEAN));
  }
  @Test
